...
# -*- coding: utf-8 -*-
"""
Raspberry Pi Camera Recorder - Barebones Version
-------------------------------------------------
✓ Raspberry Pi/Linux only
✓ V4L2 backend only
✓ Simple camera detection
✓ Recording with optional preview
✓ Tkinter GUI
"""
...
# ============ GUI Application ============
class CaptureApp:
    """Camera recorder for Raspberry Pi."""
    
    def __init__(self, root):
        self.root = root
        self.root.title("Camera Recorder — Raspberry Pi")
    ...
    def refresh_camera_list(self):
        ...
        self.available_cameras = detect_cameras(max_test=5)
    ...
    def open_camera(self):
        ...
        self.cam = Camera(
            ...
            backend=cv2.CAP_V4L2  # V4L2 only for Raspberry Pi
        )
